<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="JagoNews.home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="externalLayout">
                    ...
                    <div class="col-md-4">
                        <aside class="right_content">
                            ...
                            <div class="section_header">
                                <h2 class="section-title"><a href="#">মতামত</a><span class="line"></span></h2>
                            </div>

                            <div class="comments-section">
                                <ul class="spost_nav bg-white">
                                    <asp:Repeater ID="rptTopOpinion" runat="server">
                                        <ItemTemplate>
                                            <li>
                                                <div class="media">
                                                    <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>" class="media-left">
                                                    ...
                                                    <div class="media-body pad-top-10"><a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>"><%#Eval("content_heading")%></a></div>
                                                </div>
                                            </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section_header">
                    <h2 class="section-title"><a href="#">জাতীয়</a><span class="line"></span></h2>
                </div>
                <div class="single_iteam">
                    <div class="row">
                        <asp:Repeater ID="rptTopNational1" runat="server">
                            <ItemTemplate>
                                <div class="col-md-6">
                                    <div class="news-item-block">
                                        <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>">
                    ...
                    <div class="row">
                        <asp:Repeater ID="rptTopNational2" runat="server">
                            <ItemTemplate>
                                <div class="col-md-3">
                                    <div class="news-item-block">
                                        <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section_header">
                    <h2 class="section-title"><a href="#">খেলাধুলা</a><span class="line"></span></h2>
                </div>
                <div class="single_iteam">
                    <div class="row">
                        <asp:Repeater ID="rptSportsNews" runat="server">
                            <ItemTemplate>
                                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <div class="section_header">
                            <h2 class="section-title"><a href="#">আন্তর্জাতিক</a><span class="line"></span></h2>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single_iteam">
                                    <asp:Repeater ID="rptTopInternationalNews1" runat="server">
                                        <ItemTemplate>
                                            <div class="news-item-block">
                                                <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>">
                                                    <img alt="" src='<%#Eval("img_sm_path").ToString() %>'>
                            ...
                            <div class="col-md-6">
                                <div class="single_column">
                                    <asp:Repeater ID="rptTopInternationalNews2" runat="server">
                                        <ItemTemplate>
                                            <div class="news-item-block font-mid">
                                                <div class="media">
                                                    <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>" class="media-left">
                                                        <img alt="" src='<%#Eval("img_sm_path").ToString() %>'>
                                                    </a>
                                                    <div class="media-body pad-top-10">
                                                        <a href="/NewsDetails.aspx?cid=<%#Eval("content_id")%>"><%#Eval("content_heading")%></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </ItemTemplate>
                    ...
                    <div class="col-md-3">
                        <div class="section_header">
                            <h2 class="section-title"><a href="#">রাজনীতি</a><span class="line"></span></h2>
                        </div>
                        <div class="single_column">
                            <asp:Repeater ID="rptTopPolitics" runat="server">
                                <ItemTemplate>
                                    <ul class="spost_nav">
                                        <li>
                                            <div class="news-item-block font-mid">
                    ...
                    <div class="col-md-3">
                        <div class="section_header">
                            <h2 class="section-title"><a href="#">লাইফস্টাইল</a><span class="line"></span></h2>
                        </div>
                        <div class="single_column">
                            <asp:Repeater ID="rptTopLifestyle" runat="server">
                                <ItemTemplate>
                                    <ul class="spost_nav">
                                        <li>
                                            <div class="news-item-block font-mid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section_header">
                    <h2 class="section-title"><a href="#">বিনোদন</a><span class="line"></span></h2>
                </div>
                <div class="single_iteam">
                    <div class="row">
            ...
            <div class="col-md-8">
                <div class="section_header">
                    <h2 class="section-title"><a href="#">ফটো গ্যালারি</a><span class="line"></span></h2>
                </div>

                <div class="slider-container">
                    <div class="slick_slider">
                        <asp:Repeater ID="rptTopPhotoGalary" runat="server">
                            <ItemTemplate>
                                <div class="slick_single_iteam">
                                    <a href="/photoDetails.aspx?galid=<%#Eval("album_id")%>" class="tags">
                                        <%--<a href="<%#Eval("url").ToString() %>">--%>
                                        <img src="<%#Eval("img_path").ToString() %>" alt=""></a>
                                    <div class="slider_article">
                                        <%-- <%#Eval("description_bn").ToString() %>--%>
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
            ...
            <div class="col-md-4">
                <div class="section_header">
                    <h2 class="section-title"><a href="#">এক ক্লিকে বিভাগের খবর</a><span class="line"></span></h2>
                </div>
                <div class="col-md-12">
                    <div class="bdmap">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background: new -201 -372.5 560 776.5;" xml:space="preserve">
                            ...
                            <g id="rangpur">
                                <a href="http://www.jagonews24.com/bangladesh/rangpur" xlink:href="http://www.jagonews24.com/bangladesh/rangpur">
                        ...
                        QmCC"
                            ...
                            <g id="sylhet">
                                <a href="http://www.jagonews24.com/bangladesh/sylhet" xlink:href="http://www.jagonews24.com/bangladesh/sylhet">
                        ...
                        xM63OXPU7+FbyjXxYbf5StyWUP9/fYdf/xBgAC9n6lG6sC1xAAAAAElFTkSuQmCC"
                            ...
                            <g id="khulna">
                                <a href="http://www.jagonews24.com/bangladesh/khulna" xlink:href="http://www.jagonews24.com/bangladesh/khulna">
                        ...
                        oiMrnXhTGsZ3JpLOqicJ/j/eneNPAQYAqlIjWQakbmIAAAAASUVORK5CYII="
                            ...
                            <g id="dhaka">
                                <a href="http://www.jagonews24.com/bangladesh/dhaka" xlink:href="http://www.jagonews24.com/bangladesh/dhaka">
                        ...
                        AAAAADgafgowAC4wT/jUaBZlAAAAAElFTkSuQmCC"
                            ...
                            <g id="mymensingh">
                                <a href="http://www.jagonews24.com/bangladesh/mymensingh" xlink:href="http://www.jagonews24.com/bangladesh/mymensingh">
                        ...
                        1fX6+q8AAwAexfCEjBB1ggAAAABJRU5ErkJggg=="
                            ...
                            <g id="rajshahi">
                                <a href="http://www.jagonews24.com/bangladesh/rajshahi" xlink:href="http://www.jagonews24.com/bangladesh/rajshahi">
                        ...
                        zXvxONlKAAAAAElFTkSuQmCC"
                            ...
                            <g id="borishal">
                                <a href="http://www.jagonews24.com/bangladesh/barisal" xlink:href="http://www.jagonews24.com/bangladesh/barisal">
                        ...
                        pNtZrT3uLWr4tnf+FmAA6KLD8jcePaIAAAAASUVORK5CYII="
                            ...
                            <g id="chittagong">
                                <a href="http://www.jagonews24.com/bangladesh/chittagong" xlink:href="http://www.jagonews24.com/bangladesh/chittagong">
                ...
                <div class="filter">
                        ...
                        <ContentTemplate>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlDivisionList" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDivisionList_SelectedIndexChanged">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlDistrictList" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDistrictList_SelectedIndexChanged">
                                        <%--<asp:ListItem Selected="True" Value="">Please Select Operator</asp:ListItem>--%>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlUpozillaList" CssClass="form-control" runat="server" AutoPostBack="true">
                                        <%--<asp:ListItem Selected="True" Value="">Please Select Operator</asp:ListItem>--%>
                                    </asp:DropDownList>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <asp:Button ID="btnsearch" runat="server" CssClass="btn btn-danger btn-block" Text="অনুসন্ধান করুন" OnClick="btnsearch_Click" />
                        </div>
                    </div>
                </div>
            </div>
